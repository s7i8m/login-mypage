        ...
        <main>
            <form method="post" action="register_confirm.php" enctype="multipart/form-data">
                ...
                <div class="password">
                    ...
                    <input type="password" class="formbox" size="40" name="confirm" id="confirm" oninput="ConfirmPassword(this)" required>
                </div>
                <div class="picture">
                ...
                <div class="toroku">
                    <input type="submit" class="submit" size="35" value="登録する">
                </div>
            </form>
        </main>
